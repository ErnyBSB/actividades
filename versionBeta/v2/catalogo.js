...
/* Preencha os servidores de cada unidade. Unidades sem servidores
   cadastrados ainda podem ser usadas pelas chefias (visualização). */
const UNIDADES = {
  "SEACE":  [],
  "SEARI":  [],
  "SECAQ":  [],
  "SEDIN":  [],
  "SENOV":  [],
  "SEORE":  ["Christiane Rocha", "Silvia Regina"],
  "SEPERI": [],
  "SEREN":  []
};
