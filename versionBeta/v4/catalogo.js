...
const UNIDADES = {
  "SEACE":  { chefia: "Maurinete dos Santos", servidores: ["Corina Solino Evelin"] },
  "SEARI":  { chefia: "Fabyola Lima Madeira", servidores: ["Debora Machado de Toledo", "Glaucia Maria Marques Lopes" ] },
  "SECAQ":  { chefia: "Cristiane Medeiros Jardim", servidores: ["Ana Magna Silva Couto"] },
  "SEDIN":  { chefia: "Camila Guimarães Pereira", servidores: ["Jair Francelino Ferreira", "Marta Vieira Coelho Pereira" ] },
  "SENOV":  { chefia: "Judite Martins", servidores: ["Patricia Maria Campos de Miranda"] },
  "SEORE":  { chefia: "Christiane Coêlho da Rocha", servidores: ["Ernesto Carlos Bodê", "Silvia Regina"] },
  "SEBIB":  { chefia: "Ana Patrícia Guimarães Ferreira", servidores: ["Taissa Ferreira Pianta"] },
  "SEDEC":  { chefia: "Regina Lino de Medeiros", servidores: ["Ana Ilka Cruz Galvão", "Caroline Dantas Coelho", "Jules Rodrigues Pereira"] },
  "SEPAT":  { chefia: "Clarice de Freitas Lima", servidores: [ ] }
};

/* Nome da chefia geral (opcional; null exibe campo livre). Os
   lançamentos da chefia geral ficam na pasta GERAL da rede. */
const CHEFIA_GERAL = "Janice de Oliveira e Silva Silveira";  // substitua pelo nome real
